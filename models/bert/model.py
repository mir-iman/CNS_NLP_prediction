...
class BERT(pl.LightningModule):
    ...
    def __init__(self, config, loss_fn, steps_per_epoch):
        ...
        # Balanced Accuracy update
        self.tr_bal = Accuracy(task="binary")
        self.val_bal = Accuracy(task="binary")
        self.test_bal = Accuracy(task="binary")

        # UPDATED: store outputs manually 
    ...
    def validation_step(self, batch, batch_idx):
        ...
        step_output = {"loss": loss, "predictions": pred_labels.detach(), "labels": target_labels}

        # UPDATED: save outputs for on_validation_epoch_end
    ...
    def test_step(self, batch, batch_idx):
        ...
        # UPDATED: save outputs for on_test_epoch_end
